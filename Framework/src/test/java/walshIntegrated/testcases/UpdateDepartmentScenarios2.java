...
public class UpdateDepartmentScenarios2 extends BaseClass {
	...
	// Dept Page Update Department

	@Test(priority = 1, dependsOnMethods = "verifyPage")
	public void TC_02_Department_Update() {
		...
		dept.UpdateDepartmentsPage();

		logger.info("Department Updated");

		dept.verifyDeparment("Safety_peerjiNew");
